...
> **כל העדכונים להלן נפרסו ואומתו בשרת החי.** פירוט מלא ב-CLAUDE.md (טבלת "Audit fixes shipped"). build חי: `v20260531e` / SW `bloom-v21.9`.
>
> **בוצע:**
...
>
> **נותר לביצוע (מדורג למטה):** #3 ספירת-פרס-הבא · #4/#7 הפעלת push + loss-aversion · #5/#6/#12 הזרעת תחרויות + טורניר יומי אוטומטי · #14/#15/#16 מודרציית-שחקן + עורכי spin/trophy + דשבורד כלכלה · #22/#37 design tokens · ועוד.
