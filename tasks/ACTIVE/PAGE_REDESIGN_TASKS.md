...
| **Home (tiles)** | 88 | 84 | 84 | 84 | 90 | — | 82 | **77 → ~88** ✅ | Hot-card → slim reward strip (181→64px); תחרות/דו-קרב/אתגרים/סקינים now ON the fold; pid demoted to footer; tier-maxed score chase. The fold funnels to PLAY + the competitive loops. |
