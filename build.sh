...
cat "$CSS_DIR"/base.css "$CSS_DIR"/home.css "$CSS_DIR"/home-v2.css "$CSS_DIR"/home-v3.css "$CSS_DIR"/screens.css "$CSS_DIR"/viral.css "$CSS_DIR"/tiles-aurora.css "$CSS_DIR"/boards.css "$CSS_DIR"/bottom-nav.css "$CSS_DIR"/discovery.css "$CSS_DIR"/dark.css > "$OUT_CSS"
